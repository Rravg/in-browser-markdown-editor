...
interface HeaderMarkdownProps {
    preview: boolean;
    setPreview: Function;
}

export default function HeaderMarkdown({ preview, setPreview }: HeaderMarkdownProps): JSX.Element {
    ...
    return (
        <StyledHeader>
            <Title className="heading-s">MARKDOWN</Title>
